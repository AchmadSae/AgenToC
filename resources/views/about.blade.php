            ...
            <div class="card-body">
                ...
                <div class="mb-18">
                    ...
                    <div class="mb-10">
                        ...
                        <div class="text-center mb-15">
                            ...
                            <!--end::Title-->
                            <!--begin::Text-->
                            <div class="fs-5 text-muted fw-semibold">Within the last 10 years, we have sold
                                over
                        ...
                        <div class="overlay">
                            ...
                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                <a href="/coming_soon" class="btn btn-primary">Pricing</a>
                                <a href="/login" class="btn btn-light-primary ms-3">Join Us</a>
                            </div>
                            <!--end::Links-->
                        </div>
                        <!--end::Container-->
                    ...
                    <div class="fs-5 fw-semibold text-gray-600">
                        ...
                        <p class="mb-8">First, a disclaimer – the entire process of writing a blog post
                            often
                            takes
                            more than a couple of hours, even if you can type eighty words per minute and
                            your
                            writing skills are sharp. From the seed of the idea to finally hitting
                            “Publish,”
                            you
                            might spend several days or maybe even a week “writing” a blog post, but it’s
                            important
                        ...
                        <p class="mb-8">Before you do any of the following steps, be sure to pick a topic
                            ...
                            will
                            kill a
                            blog post more effectively than a lack of enthusiasm from the writer. You can
                            tell
                            when
                        ...
                        <p class="mb-17">I can hear your objections already. “But Dan, I have to blog for a
                            cardboard box manufacturing company.” I feel your pain, I really do. During the
                            course
                            of my career, I’ve written content for dozens of clients in some
                            less-than-thrilling
                            industries (such as financial regulatory compliance and corporate housing), but
                            the
                            hallmark of a professional blogger is the ability to write well about any topic,
                            no
                            matter how dry it may be. Blogging is a lot easier, however, if you can muster
                            at
                            least
                ...
                <div class="card bg-light mb-18">
                    ...
                    <div class="card-body py-15">
                        ...
                        <div class="fs-2 fw-semibold text-muted text-center mb-3">
                            ...
                            write about it in a
                            <br />
                            <span class="text-gray-700 me-1">more powerful</span>, emotionally expressive
                            way
                        ...
                        <div class="fs-2 fw-semibold text-muted text-center">
                            <a href="account/security.html" class="link-primary fs-4 fw-bold">Marcus
                                Levy</a>
                ...
                <div class="mb-16">
                    ...
                    <div class="text-center mb-12">
                        ...
                        <!--end::Title-->
                        <!--begin::Text-->
                        <div class="fs-5 text-muted fw-semibold">Our goal is to provide a complete and
                            robust
                            theme
                            solution
                            ...
                            <div class="card-xl-stretch me-md-6">
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="fw-semibold fs-5 text-gray-600 text-gray-900 mt-3 mb-5">
                                        We’ve
                                        been
                                        focused on making a the from also not been afraid to and step away
                                        been
                                    ...
                                    <div class="fs-6 fw-bold">
                                        <!--begin::Author-->
                                        <a href="apps/projects/users.html" class="text-gray-700 text-hover-primary">Jane
                                            Miller</a>
                                        <!--end::Author-->
                                        <!--begin::Date-->
                            ...
                            <div class="card-xl-stretch mx-md-3">
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="fw-semibold fs-5 text-gray-600 text-gray-900 mt-3 mb-5">
                                        We’ve
                                        been
                                        focused on making the from v4 to v5 but we have also not been afraid
                                        to
                                        step
                                    ...
                                    <div class="fs-6 fw-bold">
                                        <!--begin::Author-->
                                        <a href="apps/projects/users.html" class="text-gray-700 text-hover-primary">Cris
                                            Morgan</a>
                                        <!--end::Author-->
                                        <!--begin::Date-->
                            ...
                            <div class="card-xl-stretch ms-md-6">
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="fw-semibold fs-5 text-gray-600 text-gray-900 mt-3 mb-5">
                                        We’ve
                                        been
                                        focused on making the from v4 to v5 but we’ve also not been afraid
                                        to
                                        step
                                        away been focused</div>
                                    <!--end::Text-->
                ...
                <div class="mb-18">
                    ...
                    <div class="text-center mb-12">
                        ...
                        <!--end::Title-->
                        <!--begin::Sub-title-->
                        <div class="fs-5 text-muted fw-semibold">It’s no doubt that when a development takes
                            longer
