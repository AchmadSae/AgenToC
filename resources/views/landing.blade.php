                                    ...
                                    <div class="w-100 d-flex flex-column flex-center rounded-3 bg-body py-15 px-10">
                                        ...
                                        <div class="w-100 mb-10">
                                            ...
                                            <div class="d-flex flex-stack mb-5">
                                                <span class="fw-semibold fs-6 text-gray-800 text-start pe-3">Up to 10
                                                    Active Users</span>
            ...
            <div class="d-flex flex-stack flex-wrap flex-md-nowrap card-rounded shadow p-8 p-lg-12 mb-n5 mb-lg-n13"
                ...
                <div class="my-2 me-5">
                    ...
                    <div class="fs-1 fs-lg-2qx fw-bold text-white mb-2">
                        Be our contributor and get your flexible work life balance,
                        <span class="fw-normal">Speed Up Worker Freelance!</span>
                    </div>
                    <!--end::Title-->
                    <!--begin::Description-->
                    <div class="fs-6 fs-lg-5 text-white fw-semibold opacity-75">
                        Join over 100,000 Professionals Worker to Stay Ahead
                    </div>
                    <!--end::Description-->
                </div>
                <!--end::Content-->
                <!--begin::Link-->
                <a href="/join" class="btn btn-lg btn-outline border-2 btn-outline-white flex-shrink-0 my-2">Create
                    Accounts</a>
                <!--end::Link-->
            </div>
            <!--end::Highlight-->
