                                          ...
                                          <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                                                ...
                                                <div style="text-align:center; margin:0 60px 34px 60px">
                                                      ...
                                                      <div style="font-size: 14px; font-weight: 500; margin-bottom: 42px; font-family:Arial,Helvetica,sans-serif">
                                                            <p style="margin-bottom:9px; color:#181C32; font-size: 22px; font-weight:700">Complete Your Order!</p>
                                                            <p style="margin-bottom:2px; color:#7E8299">Make sure the detail your oder</p>
                                                            <p style="margin-bottom:2px; color:#7E8299">Be main the payment address</p>
