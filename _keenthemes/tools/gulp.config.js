const gulpConfig = {
    ...
    config: {
        ...
        // ✅ Konfigurasi path yang benar sesuai struktur Laravel
        path: {
            src: "../src", // relatif dari tools/
            common_src: "../src", // kalau tidak multi-demo, tetap sama
        ...
        plugins: {
            ...
            custom: {
                ...
                typedjs: {
                    src: {
                        scripts: [
                            "{$config.path.node_modules}/typed.js/dist/typed.umd.js",
                        ],
                    },
                    dist: {
                        scripts:
