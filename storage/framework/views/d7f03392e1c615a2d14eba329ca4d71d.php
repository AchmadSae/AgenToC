...
<?php $component->withAttributes([]); ?>
      ...
      <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            <!--begin::Logo-->
            <a href="<?php echo e(route('landing')); ?>" class="d-block d-lg-none mx-auto py-20">
            ...
            <div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
                  ...
                  <div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
                        ...
                        <div class="d-flex flex-stack py-2">
                              <!--begin::Back link-->
                              <div class="me-2">
                                    <a href="<?php echo e(route('sign-in', ['flag' => 'user'] )); ?>" class="btn btn-icon bg-light rounded-circle">
                              ...
                              <div class="m-0">
                                    ...
                                    <a href="<?php echo e(route('sign-up',['flag' => 'user'])); ?>" class="link-primary fw-bold fs-5" data-kt-translate="password-reset-head-link">Sign In</a>
                              </div>
                              <!--end::Sign Up link=-->
                        </div>
                        <!--end::Header-->
                        ...
                        <div class="py-20">
                              <!--begin::Form-->
                              <form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" id="kt_password_reset_form" data-kt-redirect-url="<?php echo e(route('sign-in', ['flag' => 'user']  )); ?>" action="<?php echo e(route('password-reset')); ?>">
                                    <!--begin::Heading-->
                                    ...
                                    <div class="d-flex flex-stack">
                                          ...
                                          <div class="m-0">
											...
											<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                                ...
                                                <a href="
                                                <?php echo e(route('sign-in', ['flag' => 'user'])); ?>" class="btn btn-lg btn-light-primary fw-bold" data-kt-translate="password-reset-cancel">Cancel</a>
                                          </div>
                                          <!--end::Link-->
                                    </div>
                                    <!--end::Actions-->
            ...
            <!--end::Aside-->
            <!--begin::Body-->
            <div class="d-none d-lg-flex flex-lg-row-fluid w-50 bgi-size-cover bgi-position-y-center bgi-position-x-start bgi-no-repeat" style="background-image: url(<?php echo e(asset('assets/media/auth/bg11.png')); ?>)"></div>
            <!--begin::Body-->
      </div>
...
<?php endif; ?>
<?php /**PATH D:\development\CollaborateAgenToC\AgentC\resources\views/auth/password/reset_password_email.blade.php ENDPATH**/ ?>