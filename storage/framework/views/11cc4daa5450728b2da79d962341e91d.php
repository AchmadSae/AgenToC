<div class="landing-header" data-kt-sticky="true" data-kt-sticky-name="landing-header"
    ...
    <div class="container">
        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="flex-equal text-end ms-1">
                <a href="<?php echo e(route('sign-in', ['flag' => 'user'])); ?>" class="btn btn-success">Sign In</a>
            </div>
            <!--end::Toolbar-->
        </div>
        <!--end::Wrapper-->
    ...
    <!--end::Container-->
</div><?php /**PATH D:\development\CollaborateAgenToC\AgentC\resources\views/template/header_landing.blade.php ENDPATH**/ ?>