                                                            ...
                                                            <div class="d-flex justify-content-between flex-column">
                                                                  ...
                                                                  <div class="table-responsive border-bottom mb-9">
                                                                        ...
                                                                        <span class="symbol-label"
                                                                              style="background-image:url(<?php echo e(asset('assets/media//stock/ecommerce/1.png')); ?>);"></span>
                                                                                                </a>
                                                                                                <!--end::Thumbnail-->
                                                                                                <!--begin::Title-->
                                                                                                <div class="ms-5">
                                                                                    ...
                                                                                    <td>
                                                                                          <div class="d-flex align-items-center">
                                                                                                ...
                                                                                                <a href="apps/ecommerce/catalog/edit-product.html"
                                                                                                   class="symbol symbol-50px">
                                                                        <span class="symbol-label"
                                                                              style="background-image:url( <?php echo e(asset('assets/media//stock/ecommerce/100.png')); ?>);"></span>
                                                                                                </a>
                                                                                                <!--end::Thumbnail-->
                                                                                                <!--begin::Title-->
                                                                                                <div class="ms-5">
                                                                              ...
                                                                              <tr>
                                                                                    <td colspan="3" class="fs-3 text-gray-900 fw-bold text-end">
                                                                                          Grand
                                                                                          Total</td>
                                                                                    <td class="text-gray-900 fs-3 fw-bolder text-end">$269.00
                                                                                    </td>
                                                                              </tr>
                                                                              </tbody>
                                                                        </table>
...
<?php endif; ?>
<?php /**PATH E:\iseng\AgenToC\resources\views/transaction/receipt.blade.php ENDPATH**/ ?>